...
Importante, en \LaTeX{} las comillas no se codifican como en otros editores:
\begin{itemize}
  \item Comillas latinas: <<entre símbolos menores y mayores que>>
  \item Comillas anglosajonas: inicio con dos acentos graves `` y final con dos apóstrofos ''.
\end{itemize}
\end{abstract}
